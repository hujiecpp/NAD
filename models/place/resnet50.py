...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, finding_masks, num_classes=365, zero_init_residual=False,
...
def _resnet(arch, block, layers, finding_masks, pretrained, **kwargs):
    ...
    if pretrained:
        origin_state_dict = torch.load('./pretrain_model/resnet50_best.pth.tar')['state_dict']
